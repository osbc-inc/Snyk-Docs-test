...
[컨테이너 레지스트리](../../../scan-with-snyk/snyk-container/container-registry-integrations/)와 Snyk도 통합하여 취약점을 모니터링하고 가져온 컨테이너를 정기적으로 확인할 수 있습니다. Snyk는 가져온 컨테이너를 테스트하여 발견된 알려진 보안 취약점이 있는지 확인하며, 사용자가 제어하는 빈도로 진행됩니다.

### Kubernetes

Snyk를 구성하여 Kubernetes에 배포된 작업 부하를 모니터링할 수 있습니다. 컨트롤러를 구성하는 방법에 대한 자세한 내용은 [Kubernetes 통합 개요](../../../scan-with-snyk/snyk-container/kubernetes-integration/overview-of-kubernetes-integration/)에서 확인하십시오.