...
| `project_type`                     | varchar        | 특정 프로젝트에 대해 사용할 스캔 방법, 예: Snyk 코드를 사용한 정적 어플리케이션 보안 테스트 (SAST) 또는 Maven을 사용한 Maven 프로젝트에 대한 . 이는 스캔의 구성 일부입니다. |
...
| `product_display_name`                    | varchar        | 이 상호 작용 중에 사용된 Snyk 제품입니다. 예를 들어, , , ,  등이 있습니다.                                                                                                                                                                                                                   |
