...
4.  Helm 저장소를 추가합니다:
    ...
    ```
5. 기본 지역(미국) 외의 [다른 지역](../../../working-with-snyk/regional-hosting-and-data-residency.md)에 데이터가 호스팅되는 경우, Helm 차트를 설치할 때 `snykAPIBaseURL`을 다음 형식으로 설정해야 합니다: `api.<<REGION>>.snyk.io:443`, 예: `api.eu.snyk.io:443`
