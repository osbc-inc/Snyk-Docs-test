...
그룹 수준 뷰어, 생성 및 편집 서비스 계정 권한을 갖는 사용자는 자신의 조직에 새로운 서비스 계정을 설정하고 역할을 할당할 수 있습니다.

조직을 선택하고 **설정** > **서비스 계정**으로 이동하여 이동하세요. 이름을 제공하고 드롭다운에서 역할을 선택하고 **생성**을 클릭하세요.
...
서비스 계정에 할당된 역할을 열면 시스템이 경고 메시지를 표시합니다. 권한을 업데이트하거나 삭제하여 서비스 계정 및 사용자를 새