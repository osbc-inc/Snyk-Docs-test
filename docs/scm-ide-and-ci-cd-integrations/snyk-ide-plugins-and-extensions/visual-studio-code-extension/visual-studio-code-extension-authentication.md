...
Snyk은 다음 프로토콜을 지원하여 인증합니다:

* OAuth 2.0 (기본)
* Snyk API 토큰 (폴백 옵션)

두 방법 모두 Snyk은 토큰을 안전하게 저장하기 위해 [시크릿 저장소 API](https://code.visualstudio.com/api/references/vscode-api#SecretStorage)를 사용합니다. 이 저장소는 시스템의 키체인을 사용하여 토큰을 관리합니다.
...
Snyk과 함께 인증할 때 사용자는 인증 URL을 클립보드로 복사할 수 있습니다.
