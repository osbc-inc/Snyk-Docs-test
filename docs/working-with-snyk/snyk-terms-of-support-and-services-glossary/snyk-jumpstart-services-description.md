...
7. 고객은 작업을 완료하기 위해 Snyk이 필요로 하는 모든 시스템 및 리소스에 신속하게 액세스를 제공합니다.&#x20;
8. Snyk은 Snyk 솔루션의 일환으로 사용되는 버전 관리 시스템, 저장소 관리, 문제 티켓팅 시스템, 패키징 및 기타 소프트웨어와 같은 제3자 소프트웨어에 대한 지원을 제공하지 않습니다.&#x20;
