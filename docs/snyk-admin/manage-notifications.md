...
3. **취약점** 또는 **라이센스 위반** 상자 중 하나가 확인된 경우, Snyk이 경고 이메일을 보낼 문제의 심각도를 드롭다운 목록에서 **모든 심각성** 또는 **중대한 심각성**을 선택하여 지정합니다.
...
사용량 경고 이메일은 사용량 한도에 접근할 때 Snyk이 경고하는 알림입니다.
...
조직의 알림 설정을 정의하여 Snyk이 해당 개인 알림 설정을 변경하지 않은 조직 내 모든 개인에게 이메일을 어떻게 전송할지 결정할 수 있습니다.
...
* **취약점** 또는 **라이센스 위반** 상자 중 하나가 확인된 경우, Snyk이 경고 이메일을 보낼 문제의 심각도를 드롭다운 목록에서 **모든 심각성** 또는 **중대한 심각성**을 선택하여 지정합니다.

#### 주간 보고 이메일을 위한 조직 기본 설정

주간 보고 이메일은 Snyk이 소속된 모든 프로젝트 및 조직의 취약성 상태를 요약해주는 알림입니다.
...
Snyk이 이메일을 보내는 방법에 대한 기본 설정을 가지고 있는 조직이 있습니다.
...
이슈 경고 이메일은 Snyk이 새로운 취약성, 라이선스 문제 또는 해결 조치를 발견한 날에 보내는 알림입니다.
